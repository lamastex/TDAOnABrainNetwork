...
t = time.process_time()
###############################################################################
directory = "../my_model/output/GB/general_reconstruction/"
###############################################################################
full = [
...
np.save('../my_model/output/GB/gen_biol.npy', M)
# np.save('../my_model/output/array_mc' + str(mc) + '_' + str(m_type) + '_biologicaL.npy', M)
##############################################################################
