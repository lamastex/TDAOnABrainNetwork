...
# script to concatenate all csv files into one large matrix with all m-types, saved as an npy file
# this reproduces the original Bio-M model
# also computes simplices for each dimension